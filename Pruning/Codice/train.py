...
def training_loop(model, criterion, optimizer, scheduler,
    ...
    for epoch in range(0, epochs):
        ...
        #finisco il training quando arrivo ad una valid_acc di 98.5%
        if valid_acc >= 0.985:
            print(f'Stop anticipato del training... La validation accuracy ha raggiunto il 98.5% all epoca {epoch}')
            break
